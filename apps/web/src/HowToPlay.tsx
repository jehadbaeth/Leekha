  ...
  ar: [
    {
      ...
      body: [
        ...
        'من يفوز بالأخذة "يأكل" نقاط العقوبة فيها. تتراكم النقاط عبر الجولات نحو هدف 201.',
      ],
    },
    {
      title: 'التمرير',
    ...
    },
    {
      ...
      body: [
        'إذا لم تستطع اللحاق بنوع الورقة التي بدأت الأخذة، وكنت تحمل ورقة ليخة (10♦ أو Q♠ أو K♣)، يجب أن تلعب واحدة منها.',
        'مثال: بدأت الأخذة بالقلوب. ليس معك قلوب، لكن معك Q♠. يجب أن تلعب Q♠، حتى لو كان شريكك هو من يفوز بالأخذة.',
        'عندها تطبَّق قاعدة اللعب تحت: بمجرد أن تدخل ورقة ليخة الأخذة، يجب على كل من يلعب بعدها أن يلعب ورقة أقل منها إن استطاع.',
      ],
    },
    {
      title: 'بقاء الفريق',
      body: [
        ...
        'غالباً ما يفوز الشريك السليم عمداً بأخذات فيها نقاط لحماية شريك قريب من الهدف. يُسمى هذا التضحية.',
        'راقب صفوف النقاط: يُبرز أي لاعب على بعد 30 نقطة من الهدف ليرى الجميع الخطر.',
      ],
    },
  ],
};
